...
export default function About(props) {
    ...
    let myStyle = {
        color: props.mode === 'dark'?'white':'#2e2d38',
        backgroundColor: props.mode === 'dark'?'#2e2d38':'white'
    }


  return (
        <div className="container my-3" style={{color: props.mode === 'dark'?'white':'#2e2d38',}}>
            ...
            <div className="accordion" id="accordionExample" >
                <div className="accordion-item">
                    ...
                    <div className="accordion-body" style={myStyle}>
                        Textutility gives you a way to analyze your text quickly and efficiently. Be it word count, 
                        character count or                   
                     </div>
                    </div>
                </div>
